...
export function LoadingGlobal() {
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      <div className="loading-global bg-[#ffff] w-16 h-16 flex items-center justify-center rounded-full animate-spin">
        <svg width="80" height="80" viewBox="0 0 64 64" fill="none">
          <path
            d="M8 32 A28 28 0 0 1 56 32"
            stroke="#02B2DE"
            strokeWidth="2"
            strokeLinecap="round"
          />
          ...
          <path
            d="M30 8 Q10 26 28 56"
            stroke="#02B2DE"
            strokeWidth="2"
            strokeLinecap="round"
          />
          <path
            d="M36 9 Q50 32 38 56"
            stroke="#02B2DE"
            strokeWidth="2"
            strokeLinecap="round"
          />
